            ...
            <div class="banner-left floatleft">
                ...
                <div class="slider-banner">
                    <div class="single-banner banner-1">
                        <a class="banner-thumb" href="#"><img src="img/1.jpg" alt="" /></a>
                    ...
                    <div class="single-banner banner-2">
                        <a class="banner-thumb" href="#"><img src="img/2.jpg" alt="" /></a>
                        <div class="banner-brief">
                ...
                <div class="slider-area">
                    <div class="bend niceties preview-2">
                        <div id="ensign-nivoslider" class="slides">
                            <img src="img/1.jpg" alt="" title="#slider-direction-1" />
                            <img src="img/2.jpg" alt="" title="#slider-direction-2" />
                            <img src="img/3.jpg" alt="" title="#slider-direction-3" />
                        </div>
                        <!-- direction 1 -->
        ...
        <div class="blog-area pt-55">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <h2 class="title-border">Xem tất cả sản phẩm</h2>
                        </div>
                    </div>
                </div>
                <!-- Section-title end -->
