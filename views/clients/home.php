...
<!-- Mirrored from template.hasthemes.com/hurst-v1/hurst/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 12:04:36 GMT -->
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul>
                                ...
                                <li><a href="?act=shop.php">SẢN PHẨM</a></li>
    ...
    <section class="slider-area slider-style-2">
        <div class="bend niceties preview-2">
            <div id="ensign-nivoslider" class="slides">
                <img src="assets/img/slider/slider-2/1.jpg" alt="" title="#slider-direction-1" />
                <img src="assets/img/slider/slider-2/2.jpg" alt="" title="#slider-direction-2" />
                <img src="assets/img/slider/slider-2/3.jpg" alt="" title="#slider-direction-3" />
            </div>
            <!-- direction 1 -->
                    ...
                    <div class="title-container s-tb-c title-compress">
                        <div class="layer-1">
                            ...
                            <div class="wow fadeInUpBig" data-wow-duration="2.5s" data-wow-delay="0.5s">
                                <h2 class="slider-title1 text-uppercase mb-0"><span class="d-none d-md-block">elegent
                                    </span> furniture</h2>
                            </div>
                            ...
                            <div class="wow fadeInUpBig" data-wow-duration="3.5s" data-wow-delay="0.5s">
                                <a href="#" class="button-one style-2 text-uppercase mt-20" data-text="Shop now">Shop
                                    now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="title-container s-tb-c title-compress">
                        <div class="layer-1">
                            ...
                            <div class="wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                <h2 class="slider-title1 text-uppercase"><span class="d-none d-md-block">elegent </span>
                                    furniture</h2>
                            </div>
                            <div class="wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="0.5s">
                                <p class="slider-pro-brief">There are many variations of passages of Lorem Ipsum
                                    ...
                                    going to use a passage of Lorem Ipsum, you need to be sure there hidden in the
                                    middle of text.</p>
                            </div>
                            <div class="wow fadeInUpBig" data-wow-duration="2.5s" data-wow-delay="0.5s">
                                <a href="#" class="button-one style-2 text-uppercase mt-20" data-text="Shop now">Shop
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="single-banner banner-1 banner-4">
                        <a class="banner-thumb" href="?act=detailproduct"><img src="assets/img/banner/3.jpg"
                                alt="" /></a>
                ...
                <div class="col-md-7">
                    ...
                    <div class="single-banner banner-3">
                        <a class="banner-thumb" href="?act=detailproduct"><img src="assets/img/banner/4.jpg"
                                alt="" /></a>
                        <div class="banner-brief">
                        ...
                        <div class="col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <a href="?act=detailproduct"><img src="upload/<?= $sp['img'] ?>" alt=""
                                            srcset=""></a>
                                </div>
                                <div class="product-info clearfix text-center">
                                    <div class="fix">
                                        <h4 class="post-title"><a
                                                href="?act=detailproduct"><?= $sp['ten_san_pham'] ?></a></h4>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 col-sm-6">
                                            <a href="single-blog.html">
                                                <img src="assets/img/discount/5.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-6">
                                            <div class="discount-info">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed does
                                                    eiusmodes tempor incididunt ut labore labore et labore et dolore
                                                    magna aliqua. Ut enim ad minim venim.</p>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <a href="?act=detailproduct"><img src="assets/img/product/11.jpg" alt="" /></a>
                                </div>
                                <div class="product-info clearfix text-center">
                                    <div class="fix">
...
<!-- Mirrored from template.hasthemes.com/hurst-v1/hurst/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 12:04:44 GMT -->
